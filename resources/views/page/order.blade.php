        ...
        <div id="content">
            @if(Session::has('cart'))
                @if(count($cart->items) > 0)
                    <form action="{{route('Order')}}" method="post" class="beta-form-checkout" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-block">
                                    ...
                                    <input id="gender" name="gender" type="radio" class="input-radio" name="gender" value="nữ" style="width: 10%"><span>Nữ</span>
                                        ...
                                        <div class="your-order-item">
                                            <div>
                                                @foreach($product_cart as $item)
                                                    <div class="media">
                                                        <img width="25%" src="source/image/product/{{$item['item']['image']}}" alt="{{$item['item']['name']}}" class="pull-left">
                                                        <div class="media-body">
                                                            ...
                                                            <span class="color-gray your-order-info">Quantity: {{$item['quantity']}}</span>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
