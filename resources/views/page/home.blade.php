                ...
                <div class="col-sm-12">
                    <div class="beta-products-list">
                        ...
                        <div class="beta-products-details">
                            <p class="pull-left">{{count($listNewProducts)}} styles found</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            @foreach($listNewProducts as $item)    
                                <div class="col-sm-3">
                        ...
                        <div class="row">{{$listNewProducts->links()}}</div>
                    ...
                    <div class="beta-products-list">
                        <h4>Top Products</h4>
                        <div class="beta-products-details">
                            <p class="pull-left">{{count($listTopProducts)}} styles found</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            @foreach($listTopProducts as $item)
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        @if($item->promotion_price != 0)
                                            <div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
                        ...
                        <div class="row">{{$listTopProducts->links()}}</div>
                    </div> <!-- .beta-products-list -->
                </div>
